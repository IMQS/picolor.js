...
(function (picolor) {
    ...
    picolor.whiteToBlackInterpolator = chroma.interpolate.bezier(['white', 'black']);
    var SingleColor = (function () {
        function SingleColor(containerDivID, options) {
            ...
            // add DOM structure 
            var content = '<div class="picolor-container">' + '	<div class="picolor-top-container">' + '		<div id="' + this.colorBandDivID + '-0' + '"></div>' + '		<div id="' + this.colorBandDivID + '-1' + '"></div>' + '		<div id="' + this.blackToWhiteBandDivID + '" style="margin-top: 6px"></div>' + '	</div>' + '	<div class="picolor-bottom-container">' + '		<canvas id="' + this.colorWheelDivID + '" class="picolor-wheel"></canvas>' + '	</div>' + '</div>';
        ...
        SingleColor.prototype.drawColorWheel = function () {
            ...
            var picked_x, picked_y; // canvas coordinates of picked color
    ...
    var Palette = (function () {
        function Palette(containerDivID) {
            this.containerDivID = containerDivID;
        }
        return Palette;
    })();
