...
(function(n) {
  ...
  var r = function() {
    function e(a, b) {
      ...
      var d = '<div class="picolor-container">\t<div class="picolor-top-container">\t\t<div id="' + this.colorBandDivID + '-0"></div>\t\t<div id="' + this.colorBandDivID + '-1"></div>\t\t<div id="' + this.blackToWhiteBandDivID + '" style="margin-top: 6px"></div>\t</div>\t<div class="picolor-bottom-container">\t\t<canvas id="' + this.colorWheelDivID + '"></canvas>\t</div></div>', e = $("#" + this.containerDivID);
      e.empty();
      e.append(d);
    ...
    Object.defineProperty(e.prototype, "showColorWheel", {get:function() {
      return this._showColorWheel;
    }, set:function(a) {
      this._showColorWheel = a;
      this.draw();
    }, enumerable:!0, configurable:!0});
    Object.defineProperty(e.prototype, "showLabels", {get:function() {
      return this._showLabels;
    }, set:function(a) {
      this._showLabels = a;
      this.draw();
    }, enumerable:!0, configurable:!0});
    Object.defineProperty(e.prototype, "showBasicSelector", {get:function() {
    ...
    e.prototype.drawBasicSelector = function() {
    ...
    e.prototype.drawColorWheel = function() {
      ...
      b.stroke();
      b.beginPath();
      128 > this.alpha && (b.strokeStyle = "#2f2f2f");
      b.arc(f, d, 6, 0, 2 * Math.PI, !1);
      b.stroke();
      b.beginPath();
      f = Math.min(this.height - 35, 30 + (1 - this.alpha / 255) * (this.height - 60));
  ...
  r = function() {
    function e(a, b) {
      ...
      b && this.setOptions(b);
      var f = '<div class="picolor-container">\t<canvas id="' + this.paletteCanvasDivID + '"></canvas></div>', d = $("#" + this.containerDivID);
      d.empty();
      d.append(f);
