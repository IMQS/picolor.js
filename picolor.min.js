...
(function(n) {
  ...
  var r = function() {
    function f(a, b) {
      ...
      var d = '<div class="picolor-container">\t<div class="picolor-top-container">\t\t<div id="' + this.colorBandDivID + '-0"></div>\t\t<div id="' + this.colorBandDivID + '-1"></div>\t\t<div id="' + this.blackToWhiteBandDivID + '" style="margin-top: 6px"></div>\t</div>\t<div class="picolor-bottom-container">\t\t<canvas id="' + this.colorWheelDivID + '"></canvas>\t</div></div>', f = $("#" + this.containerDivID);
      f.empty();
      f.append(d);
    ...
    Object.defineProperty(f.prototype, "showColorWheel", {get:function() {
      return this._showColorWheel;
    }, set:function(a) {
      this._showColorWheel = a;
      this.draw();
    }, enumerable:!0, configurable:!0});
    Object.defineProperty(f.prototype, "showLabels", {get:function() {
      return this._showLabels;
    }, set:function(a) {
      this._showLabels = a;
      this.draw();
    }, enumerable:!0, configurable:!0});
    Object.defineProperty(f.prototype, "showBasicSelector", {get:function() {
    ...
    f.prototype.drawBasicSelector = function() {
      for (var a = this, b = function(b, e) {
        for (var c = "", d = 0;d < b.length;d++) {
          var f = e + "-" + d, c = c + ('<div id="' + f + '" class="picolor-box-container');
          a.getColor().css() === b[d].css() && (c += " picolor-box-container-selected");
          c += '">';
          c += '\t<div class="picolor-box" style="background-color:' + b[d].css() + '"></div>';
          c += "</div>";
          $("#" + a.containerDivID).on("click", "#" + f, b[d].lch(), function(b) {
            a.lch = b.data;
          });
        }
        $("#" + e).empty();
    ...
    f.prototype.drawColorWheel = function() {
      this.offset = $("#" + this.colorWheelDivID).offset();
      var a = document.getElementById(this.colorWheelDivID), b = a.getContext("2d"), e, d, f = Number.MAX_VALUE;
      a.width = this.width;
      ...
      for (var a = b.createImageData(this.width, this.height), g = a.data, c = 0, k = 0;k < this.height;k++) {
        for (var l = 0;l < this.width;l++, c += 4) {
          ...
          if (n < this.radius + 0.5) {
            ...
            g[c] = s * h / 255 + p * (1 - h / 255);
            g[c + 1] = r * h / 255 + q * (1 - h / 255);
            g[c + 2] = u * h / 255 + t * (1 - h / 255);
            g[c + 3] = 255 * Math.max(0, this.radius - n);
          }
        }
      }
      for (k = c = 0;k < this.height;k++) {
        for (l = 0;l < this.width;l++, c += 4) {
          30 > k || k > this.height - 30 || 2 > l || 15 < l || (m = chroma.lch2rgb(100 - 100 * (k - 30) / (this.height - 60), this.lch[1], this.lch[2]), g[c] = m[0], g[c + 1] = m[1], g[c + 2] = m[2], g[c + 3] = 255);
        }
      }
      c = 0;
      ...
      for (k = 0;k < this.height;k++) {
        for (l = 0;l < this.width;l++, c += 4) {
          30 > k || k > this.height - 30 || l < this.width - 16 || l > this.width - 3 || (h = 255 - 255 * (k - 30) / (this.height - 60), s = m[0], r = m[1], u = m[2], p = 0 == Math.floor(l / 5) % 2, q = 0 == Math.floor(k / 5) % 2, q = p = t = p && !q || !p && q ? 250 : 200, g[c] = s * h / 255 + p * (1 - h / 255), g[c + 1] = r * h / 255 + q * (1 - h / 255), g[c + 2] = u * h / 255 + t * (1 - h / 255), g[c + 3] = 255);
        }
      }
  ...
  r = function() {
    ...
    Object.defineProperty(f.prototype, "hexPalette", {get:function() {
      for (var a = [], b = this.palMatrix[this.selectedPalIdx], e = 0;e < b.length;e++) {
        a.push(b[e].hex());
      }
      return a;
    }, enumerable:!0, configurable:!0});
    ...
    f.prototype.draw = function() {
      ...
      for (a = 0;a < this.sequentialPalettes.length;a++) {
        for (var d = [], f = this.sequentialPalettes[a], g = 0;g < e;g++) {
          var c = g / (e - 1);
          d.push(f(c).hex());
        }
      ...
      for (a = 0;a < this.divergentPalettes.length;a++) {
        for (var d = [], f = this.divergentPalettes[a][0], k = this.divergentPalettes[a][1], g = 0;g < e;g++) {
          c = g / (e - 1), c = 0.5 >= c ? f(2 * c) : k(2 * (c - 0.5)), d.push(c);
        }
        this.palMatrix.push(d);
      }
