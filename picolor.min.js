    ...
    f.prototype.draw = function() {
      ...
      for (var b = function(b, c) {
        for (var e = "", d = 0;d < b.length;d++) {
          var f = c + "-" + d, e = e + ('<div id="' + f + '" style="width: 38px;height: 24px;cursor: pointer;display: inline-block;padding: 1px;background-color: #E0E0E0;margin: 0px 4px 0px 4px;'), e = a.color.hex() === b[d].hex() ? e + " border: 2px solid black;" : e + " border: 2px solid #E0E0E0;", e = e + '">', e = e + ('\t<div style="height: 24px; background-color:' + b[d].css() + '"></div>'), e = e + "</div>";
